...
description: 实时关注 Ta 的微博，通过 AI 分析微博动态的情绪心情，并通过 Bark 或 PushDeer 进行通知。基于 Node.js 的开源脚本。
pubDatetime: 2024-09-04T15:59:05Z
author: Wqchnggyu
ogImage: https://i0.wp.com/uxiaohan.github.io/v2/2024/09/1725437035.webp
tags:
  - 微博动态
  - 心情分析
  - AI
